    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=15, validators=[django.core.validators.MinLengthValidator(limit_value=3, message='Username must be at least 3 chars long!'), django.core.validators.RegexValidator(message='Username must contain only letters, digits, and underscores!', regex='^[\\w]+$')])),
